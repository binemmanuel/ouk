import '../onboarding_screen_two_one_screen/widgets/teamworkprofile_item_widget.dart';
import 'package:flutter/material.dart';
import 'package:ouk/core/app_export.dart';

class OnboardingScreenTwoOneScreen extends StatelessWidget {
              ...
              Expanded(
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return TeamworkprofileItemWidget();
                  },
                ),
              ),
            ],
