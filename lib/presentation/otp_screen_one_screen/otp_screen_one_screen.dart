...
class OtpScreenOneScreen extends StatelessWidget {OtpScreenOneScreen({Key? key}) : super(key: key);
...
onTapVerifyotp(BuildContext context) { Navigator.pushNamed(context, AppRoutes.dashboardScreen); } 
 }
