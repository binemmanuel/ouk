...
class NewPasswordScreen extends StatelessWidget {NewPasswordScreen({Key? key}) : super(key: key);
...
onTapCreatenew(BuildContext context) { Navigator.pushNamed(context, AppRoutes.dashboardScreen); } 
 }
